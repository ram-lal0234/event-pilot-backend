...
copy_src "${SHARED_LAYER}" "services/outreach.service.js"
copy_src "${SHARED_LAYER}" "services/outreach-schedule.service.js"
copy_src "${SHARED_LAYER}" "services/scheduled-outreach.service.js"
for repo in "${ROOT_DIR}"/src/repositories/*.js; do
  copy_src "${SHARED_LAYER}" "repositories/$(basename "${repo}")"
done

copy_src "${SHARED_LAYER}" "services/access.service.js"
...
copy_src "${SHARED_LAYER}" "services/voice-rsvp-capture.service.js"
...
copy_src "${SHARED_LAYER}" "utils/role-capabilities.js"
copy_src "${SHARED_LAYER}" "utils/phone.util.js"
copy_src "${SHARED_LAYER}" "utils/app-url.util.js"
copy_src "${SHARED_LAYER}" "utils/public-rsvp.util.js"
copy_src "${SHARED_LAYER}" "utils/outreach-message.util.js"
...
node "${ROOT_DIR}/scripts/check-layer-deps.js"
